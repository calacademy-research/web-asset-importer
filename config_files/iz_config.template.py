...
CASIZ_NUMBER_SHORT = '([0-9]{' + str(SHORT_MINIMUM_ID_DIGITS) + ','+ str(SHORT_MAXIMUM_ID_DIGITS)+'})'

CASIZ_PREFIX = r'cas(iz)?[#a-z _]*[_ \-]?'

CASIZ_MATCH_SHORT = CASIZ_PREFIX + CASIZ_NUMBER_SHORT
CASIZ_MATCH = CASIZ_NUMBER
CASIZ_MATCH_SHORT = CASIZ_PREFIX + CASIZ_MATCH_SHORT
