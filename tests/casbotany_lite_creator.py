...
def table_sql_list():
    ...
    sql_bot_list = ['''CREATE TABLE IF NOT EXISTS collectionobject (
                    ...
                    '''CREATE TABLE "localitydetail" (
                      ...
                      "Version" INTEGER DEFAULT NULL,
                      "BaseMeridian" TEXT DEFAULT NULL,
                      "Drainage" TEXT DEFAULT NULL,
                      "EndDepth" NUMERIC DEFAULT NULL,
                      "enddepthunit" TEXT DEFAULT NULL,
                      "EndDepthVerbatim" TEXT DEFAULT NULL,
                      "GML" TEXT,
                      "HucCode" TEXT DEFAULT NULL,
                      "Island" TEXT DEFAULT NULL,
                      "IslandGroup" TEXT DEFAULT NULL,
                      "MgrsZone" TEXT DEFAULT NULL,
                      "NationalParkName" TEXT DEFAULT NULL,
                      "Number1" NUMERIC DEFAULT NULL,
                      "Number2" NUMERIC DEFAULT NULL,
                      "RangeDesc" TEXT DEFAULT NULL,
                      "RangeDirection" TEXT DEFAULT NULL,
                      "Section" TEXT DEFAULT NULL,
                      "SectionPart" TEXT DEFAULT NULL,
                      "StartDepth" NUMERIC DEFAULT NULL,
                      "startdepthunit" TEXT DEFAULT NULL,
                      "StartDepthVerbatim" TEXT DEFAULT NULL,
                      "Text1" TEXT,
                      "Text2" TEXT,
                      "Township" TEXT DEFAULT NULL,
                      "TownshipDirection" TEXT DEFAULT NULL,
                      "UtmDatum" TEXT DEFAULT NULL,
                      "UtmEasting" NUMERIC DEFAULT NULL,
                      "UtmFalseEasting" INTEGER DEFAULT NULL,
                      "UtmFalseNorthing" INTEGER DEFAULT NULL,
                      "UtmNorthing" NUMERIC DEFAULT NULL,
                      "UtmOrigLatitude" NUMERIC DEFAULT NULL,
                      "UtmOrigLongitude" NUMERIC DEFAULT NULL,
                      "UtmScale" NUMERIC DEFAULT NULL,
                      "UtmZone" INTEGER DEFAULT NULL,
                      ...
                      "PaleoLat" TEXT DEFAULT NULL,
                      "PaleoLng" TEXT DEFAULT NULL,
                      "Text3" TEXT,
                      "Text4" TEXT,
                      "Text5" TEXT,
                      "YesNo3" INTEGER DEFAULT NULL,
